...
from .views import UploadListView, Upload
...
urlpatterns = patterns("",
                       url(r'^uploads/new$', login_required(Upload.as_view()), name='uploads-new'),
                       url(r'^uploads/new-multi-json$', login_required(Upload.as_view(json=True)),
                           name='uploads-multi-json'),
                       url(r'^uploads/new/json$', login_required(Upload.as_view(json=True)),
